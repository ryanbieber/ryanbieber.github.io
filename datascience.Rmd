...
## Data Science Projects In-progess

- World of Warcraft, Item Prices Dashboard/Forecasting, This project is semi-related to the other World of Warcraft one in which I looked at black market gold prices and compared them to token prices. This one instead is looking at all the items on the AH by server(server-group) and is going to tell you the trend/seasonaility, etc. Still a work in progress as I just started my new job so I have been focusing a lot of my time into that instead.


## Data Science Projects Completed

### This list isnt exhaustive just a few ones I picked out.
